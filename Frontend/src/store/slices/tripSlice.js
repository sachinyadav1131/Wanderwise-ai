...
const formatTripData = (trip) => {
  ...
  // Map nice cover images based on destination keywords
  let coverImage = "https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?w=800&auto=format&fit=crop";
